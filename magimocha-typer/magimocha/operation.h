...
void extract_operator_info(std::shared_ptr<operator_info_table> p, std::shared_ptr<ast::ast_leaf> target, std::unordered_map<std::shared_ptr<ast::ast_leaf>, std::shared_ptr<operator_info_table>> &map);
} // namespace tig::magimocha::codegen2