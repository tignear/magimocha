...
void register_name(
    std::shared_ptr<ast::declaration_module> target,
    std::shared_ptr<module_table> target_parent_mt,
    std::shared_ptr<variable_table> target_parent_vt,
    std::unordered_map<std::shared_ptr<ast::declaration_module>,std::shared_ptr<module_table>>& dm2mm,
    std::unordered_map<std::shared_ptr<ast::make_scope>,std::shared_ptr<variable_table>>& ms2vt
);
void register_name(
