...
struct named_data : public virtual ast_base {};
enum class type_data_type { simple, function /*,polymorphic*/, var };
struct type_data {
...
class simple_type_data final : public type_data {
  ...
  public:
    ...
    type_data_type type() const override { return type_data_type::simple; }
...
class function_type_data final : public type_data {
  public:
    ...
    function_type_data(std::shared_ptr<type_data> result_type,
                       std::vector<std::shared_ptr<type_data>> args)
        : result_type(result_type), args(args) {}
    type_data_type type() const override { return type_data_type::function; }
};
struct var_type_data final : public type_data {
    var_type_data() = default;
    type_data_type type() const override { return type_data_type::var; }
};
/*class ref_type_data final:public type_data {
                        public:
                                std::shared_ptr<type_data>  value;

                                ref_type_data(std::shared_ptr<type_data> value)
   :value(value) {} ref_type_data(){}
...
/*class declaration_name final :public typed_data {
                        ...
                        public:
                                ...
                                declaration_name(const string_type& name,
   std::shared_ptr<type_data> type_data) :name_(name) {
...
class declaration_parameter final : public typed_data,
  ...
  public:
    leaf_type type() const override { return leaf_type::declaration_parameter; }
    declaration_parameter(const string_type &name,
                          std::shared_ptr<type_data> type_data)
        : name_(name), type_data_(type_data) {}
    declaration_parameter(std::shared_ptr<type_data> type_data)
        : name_(std::nullopt), type_data_(type_data) {}
    declaration_parameter(std::optional<string_type> s,
                          std::shared_ptr<type_data> type_data)
        : name_(s), type_data_(type_data) {}
    std::shared_ptr<type_data> return_type() const override {

        return type_data_;
    }
    std::optional<string_type> name() const { return name_; }
    bool is_ignore_parameter() const { return !name_; }
};
...
class declaration_function : public expression,
  ...
  public:
    leaf_type type() const override { return leaf_type::declaration_function; }
    declaration_function(
    ...
    std::shared_ptr<expression> body() const { return body_; }
    std::shared_ptr<type_data> return_type() const override {
        return type_data_;
    }
...
class named_function final : public make_scope,
                             public expression,
  ...
  public:
    named_function(string_type name, std::shared_ptr<declaration_function> body)
        : name_(name), body_(body) {}
    leaf_type type() const override { return leaf_type::named_function; }
...
class signed_number_literal final : public integer_literal, public ast_leaf {
  ...
  public:
    leaf_type type() const override { return leaf_type::signed_number_literal; }
    explicit signed_number_literal(const std::int64_t value) : value_(value) {}
    const std::int64_t value() const { return value_; }
    std::shared_ptr<type_data> return_type() const override {
...
class unsigned_number_literal final : public integer_literal, public ast_leaf {
  ...
  public:
    ...
    explicit unsigned_number_literal(const std::uint64_t value)
        : value_(value) {}
...
class floating_literal final : public numeric_literal, public ast_leaf {
  ...
  public:
    leaf_type type() const override { return leaf_type::floating_literal; }
...
class string_literal final : public literal_, public ast_leaf {
    ...
    std::shared_ptr<type_data> rt =
        std::make_shared<simple_type_data>(U"String"); // TODO
  public:
    leaf_type type() const override { return leaf_type::string_literal; }
    explicit string_literal(const std::u32string &value) : value_(value) {}
    const std::u32string &value() const { return value_; }
    std::shared_ptr<type_data> return_type() const override { return rt; }
};
class apply_function final : public expression, public ast_leaf {
  ...
  public:
    leaf_type type() const override { return leaf_type::apply_function; }
    apply_function(std::shared_ptr<expression> target,
...
class expression_block final : public expression,
  ...
  public:
    leaf_type type() const override { return leaf_type::expression_block; }
    explicit expression_block(std::vector<std::shared_ptr<expression>> value)
        : value_(value) {}
...
class op_token_double {
  ...
  public:
    ...
    std::shared_ptr<call_name> name() const { return s_; }
};
...
class op_token_function_applying {
  ...
  public:
    explicit op_token_function_applying(
        std::vector<std::shared_ptr<expression>> args)
        : args_(args) {}

    const auto &args() const { return args_; }
};
using operator_token_type =
    std::variant<op_token_single, op_token_double, op_token_function_applying,
                 std::shared_ptr<declaration_function>,
                 std::shared_ptr<literal_>, std::shared_ptr<expression>,
                 std::shared_ptr<call_name>>;
class operation final : public expression, public ast_leaf {
    std::list<operator_token_type> value_;
    std::shared_ptr<type_data> type_data_ =
        std::make_shared<ast::var_type_data>();

  public:
    leaf_type type() const override { return leaf_type::operation; }
...
class declaration_variable final : public expression,
  ...
  public:
    declaration_variable(const string_type &name,
                         std::shared_ptr<type_data> type_data,
                         std::shared_ptr<expression> body)
        : name_(name), type_data_(type_data), body_(body) {}
    std::shared_ptr<type_data> return_type() const override {
        return type_data_;
    }
    leaf_type type() const override { return leaf_type::declaration_variable; }
    const string_type &name() const { return name_; }
    std::shared_ptr<expression> body() const { return body_; }
};
class declaration_export final : public module_member, public ast_leaf {
    ...
    public:
    declaration_export(std::vector<string_type> &&targets,
                       std::vector<string_type> to)
        : targets_(targets), to_(to) {}
    const std::vector<string_type> &targets() const { return targets_; }
    const std::vector<string_type> &to() const { return to_; }
    leaf_type type() const override { return leaf_type::declaration_export; }
};
enum class infix_type { left, right };
class declaration_infix final : public module_member,
  ...
  public:
    ...
    leaf_type type() const override { return leaf_type::declaration_infix; }
};
class declaration_import final : public module_member,
                                 public expression,
                                 public ast_leaf {
    string_type name_;
  public:
    declaration_import(const string_type &name) : name_(name) {}
    std::shared_ptr<type_data> return_type() const override {
        return std::make_shared<simple_type_data>(U"Nothing");
    }
    leaf_type type() const override { return leaf_type::declaration_import; }
